...
export default function RoseContact() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-r from-purple-800 to-indigo-700 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 text-base text-indigo-50 max-w-3xl">
                Nous répondons à vos questions en moins de 24h.
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon
                    ...
                    aria-hidden="true"
                  />
                  <a href='tel:0611076501' className="ml-3">06 11 07 65 01</a>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  <MailIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">lrpm.sasu@gmail.com</span>
                </dd>
              </dl>
              <ul role="list" className="mt-8 flex space-x-12">
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://www.facebook.com/profile.php?id=100093510793614">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://github.com/Lacapsule66">
                ...
                <li>
                  <a className="text-indigo-200 hover:text-indigo-100" href="https://twitter.com/AgenceLaCapsule">
